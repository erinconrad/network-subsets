...
%% Parameters
doPlot = 0;
dist_to_plot = 2; %1 if looking at distance to nearest resec zone elec; 2 if looking at distance to centroid of resection zone
...
dists = {'dist_nearest_resec','dist_resec','overlap_soz','overlap_resec','par_removed',...
    'bc_removed'};
...
dist_names = {'from resection zone','from resection zone',...
