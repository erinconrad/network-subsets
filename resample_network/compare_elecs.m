function [overlap,dist,dist_nearest] = compare_elecs(group_1,group_2,locs,doPlot)
...
% get the distance between group 1 centroid and the nearest group 2
% electrode
[dist_nearest,elec_nearest] = min(vecnorm(centroid_1-locs_2,2,2));
...
if doPlot == 1
    ...
    hold on
    scatter3(locs_2(elec_nearest,1),locs_2(elec_nearest,2),...
        locs_2(elec_nearest,3),50,'g','filled');
    ...
    fprintf(['The number overlapping is %d and the distance is %1.1f.\n'...
        'The nearest distance is %1.1f\n'],...
        num_overlap,dist,dist_nearest);
    pause
    close(gcf);
